...
def main(hparams):
    ...
    logger = pl.loggers.TensorBoardLogger(hparams.log_dir, name=f"bs{hparams.batch_size}_nf{hparams.nfe}")
    ...
    summary(autoencoder, (hparams.in_size, hparams.in_size, hparams.in_size), device="cpu")
